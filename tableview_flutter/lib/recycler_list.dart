...
class RecyclerList extends SliverMultiBoxAdaptorWidget {
  final double Function(int) _sizeProvider;
  final double Function(int) _offsetProvider;
  ...
  RenderSliverMultiBoxAdaptor createRenderObject(BuildContext context) {
    ...
    return _RecyclerViewAdaptor(element, _sizeProvider, _offsetProvider);
  }
}

class _RecyclerViewAdaptor extends RenderSliverFixedExtentBoxAdaptor {
  final double Function(int) _sizeProvider;
  final double Function(int) _offsetProvider;

  _RecyclerViewAdaptor(RenderSliverBoxChildManager childManager,
